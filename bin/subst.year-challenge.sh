#!/usr/bin/env bash
#
# subst.year-challenge.sh - print substitutions for a year's challenge.html
#
...
#
#	-o
#	bin/subst.year-challenge.sh
#
# will cause tools such as subst.year-challenge.sh to execute this code.
#
...
#
export VERSION="2.0.0 2026-06-10"
NAME=$(basename "$0")
export NAME
export V_FLAG=0
GIT_TOOL=$(type -P git)
...
#
echo "-s"
echo "TITLE=Fun challenges for IOCCC year $YEAR_DIR - The $ORDINAL IOCCC"
...
#
echo "-s"
echo "KEYWORDS=IOCCC, $YEAR_DIR, IOCCC $YEAR_DIR, challenge, fun challenge, Fun challenges for IOCCC year $YEAR_DIR"


# output HEADER_2 substitution
#
echo "-s"
echo "HEADER_2=Fun challenges for IOCCC year $YEAR_DIR - The $ORDINAL IOCCC"
