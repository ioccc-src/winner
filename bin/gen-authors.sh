...
unset IS_FOR
declare -Ag IS_FOR
IS_FOR[a]="<i>a is for</i> <code>atoi</code>"
IS_FOR[b]="<i>b is for</i> <code>break</code>"
IS_FOR[c]="<i>c is for</i> <code>const</code>"
IS_FOR[d]="<i>d is for</i> <code>do</code>"
IS_FOR[e]="<i>e is for</i> <code>else</code>"
IS_FOR[f]="<i>f is for</i> <code>float</code>"
IS_FOR[g]="<i>g is for</i> <code>getc</code>"
IS_FOR[h]="<i>h is for</i> <code>hypot</code>"
IS_FOR[i]="<i>i is for</i> <code>int</code>"
IS_FOR[j]="<i>j is for</i> <code>jmp_buf</code>"
IS_FOR[k]="<i>k is for</i> <code>killchar</code>"
IS_FOR[l]="<i>l is for</i> <code>long</code>"
IS_FOR[m]="<i>m is for</i> <code>malloc</code>"
IS_FOR[n]="<i>n is for</i> <code>nullptr</code>"
IS_FOR[o]="<i>o is for</i> <code>open</code>"
IS_FOR[p]="<i>p is for</i> <code>printf</code>"
IS_FOR[q]="<i>q is for</i> <code>qsort</code>"
IS_FOR[r]="<i>r is for</i> <code>return</code>"
IS_FOR[s]="<i>s is for</i> <code>switch</code>"
IS_FOR[t]="<i>t is for</i> <code>true</code>"
IS_FOR[u]="<i>u is for</i> <code>union</code>"
IS_FOR[v]="<i>v is for</i> <code>volatile</code>"
IS_FOR[w]="<i>w is for</i> <code>while</code>"
IS_FOR[x]="<i>x is for</i> <code>xor</code>"
IS_FOR[y]="<i>y is for</i> <code>y0</code>"
IS_FOR[z]="<i>z is for</i> <code>zlib</code>"
