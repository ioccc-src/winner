...
#
export VERSION="2.2.3 2026-06-17"
NAME=$(basename "$0")
export NAME
export V_FLAG=0
GIT_TOOL=$(type -P git)
...
function output_award
{
    ...
    AWARD_STRING=$("$JVAL_WRAPPER" -b -q "$ENTRY_JSON_PATH" "$PATTERN" | "$JSTRDECODE" -d -q -N -)
...
#
{
    ...
    #
    cat << EOF
<!-- BEFORE: years.md was a temporary file that was generated by the tool: bin/gen-years.sh -->
# IOCCC Winning Entries by Year

<p><b>Q</b>: Where is <b>%%THIS_YEAR%%</b>?</p>
<p><b>A</b>: That contest won't close until <b>%%NEXT_YEAR%%</b>.</p>
EOF
...
#
{
    ...
    echo '&nbsp;**Jump to:** [top](#)'
    echo
    echo '<!-- AFTER: years.md was a temporary file that was generated by the tool: bin/gen-years.sh -->'
