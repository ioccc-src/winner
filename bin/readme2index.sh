#!/usr/bin/env bash
#
# readme2index - convert a winner README.md into the winner index.html
#
# We will convert a winner README.md markdown file into winner index.html file
...
export USAGE="usage: $0 [-h] [-v level] [-V] [-d topdir] [-D docroot/] [-n] [-N]
			...
			[-u repo_url] [-w site_url] [-e string ..] [-E exitcode]
			YYYY/dir
