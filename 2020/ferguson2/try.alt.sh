...
echo 1>&2
echo "$ echo testing test tests | ./recode | ./prog.alt - 2>/dev/null" 1>&2
echo testing test tests | ./recode | ./prog.alt - 2>/dev/null
echo 1>&2
...
echo 1>&2
echo "$ echo testing test tests | ./recode | ./prog - 2>/dev/null | ./recode | ./prog.alt - 2>/dev/null" 1>&2
echo testing test tests | ./recode | ./prog - 2>/dev/null | ./recode | ./prog.alt - 2>/dev/null
echo 1>&2
