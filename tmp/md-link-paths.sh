#!/usr/bin/env bash
#
# bin/md-link-paths.sh - print local file paths referenced in markdown links
#
...
#	    -e '/^\s*$/d'
#
# We then remove all links that start with:
#
#	http:
#	https:
#
