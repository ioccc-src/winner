...
echo 1>&2
echo fier | ./kang # notice the issue here; this is intentional
echo 1>&2

read -r -n 1 -p "Press any key to run: echo vier | ./kang # 4: "
echo 1>&2
echo vier | ./kang # notice the issue he; this is intentional
echo 1>&2
...
read -r -n 1 -p "Press any key to run: echo forty-two | ./kang # 42: "
echo 1>&2
echo forty-two | ./kang
echo 1>&2
