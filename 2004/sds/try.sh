...
echo "$ ./encoder README_sds.md <sds.c | tee sds_msg.c" 1>&2
read -r -n 1 -p "Press any key to continue (space = next page, q = quit): "
echo 1>&2
./encoder README_sds.md <sds.c | tee sds_msg.c | less -rEXFK
...
echo "$ ./encoder message < README_sds.md | tee remarks.md" 1>&2
read -r -n 1 -p "Press any key to continue (space = next page, q = quit): "
echo 1>&2
./encoder message < README_sds.md | tee remarks.md | less -rEXFK
echo 1>&2

read -r -n 1 -p "Press any key to run: diff remarks.md README_sds.md (space = next page, q = quit): "
echo 1>&2
diff remarks.md README_sds.md | less -rEXFK
