...
YEARS= 1984 1985 1986 1987 1988 1989 1990 1991 1992 1993 1994 1995 1996 \
	1998 2000 2001 2004 2005 2006 2011 2012 2013 2014 2015 2018 2019 2020 \
	2024 2025
...
help:
	...
	@echo 'make gen_year_index	;: generate all year level html files using from markdown files'
	@echo 'make quick_year_index	;: generate all year level html files when markdown is newer'
	...
	@echo 'make pull_request	;: generate PULL_REQUEST_TEMPLATE.html'
...
# generate CONTRIBUTING.html
#
pull_request: ${GEN_TOP_HTML} PULL_REQUEST_TEMPLATE.md
	@echo '=-=-=-=-= IOCCC begin ${MAKE} $@ =-=-=-=-='
	@echo "You wish to pull?"
	${GEN_TOP_HTML} PULL_REQUEST_TEMPLATE
	@echo "Thanks in advance for pushing🫸 out the pull 🫷!"
	@echo '=-=-=-=-= IOCCC complete ${MAKE} $@ =-=-=-=-='
