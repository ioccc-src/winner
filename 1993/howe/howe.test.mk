...
all: howe char word anchor literal wild closure option branch sub class

#
# Built the entry
#
howe: Makefile
	make -f Makefile howe
...
anchor1:
	$(PRG) '^anchor1' howe.test.mk

anchor2:
	$(PRG) 'Grep$$' howe.test.mk
...
#
anchor4:
	-$(PRG) 'x^a' howe.test.mk

#
# This is valid but will never match.
#
anchor5:
	-$(PRG) 'mk$$x' howe.test.mk
...
#
sub0:
	$(PRG) 's()u()b()' howe.test.mk

sub1:
	$(PRG) '#(1|%)#' howe.test.mk

sub2:
	$(PRG) 'aa((bc)*|g)xx' howe.test.mk
...
class5:
	$(PRG) '=[0-9]=' howe.test.mk

class6:
	$(PRG) '=[^0-9]=' howe.test.mk

class7:
	-$(PRG) '=[3-1]=' howe.test.mk
