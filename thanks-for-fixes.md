...
Cody got this to work with clang by further changing the variable `a` to be not
the third argument to `main()` and instead be a variable declared in `main()`.
...
alarming warning at compiling and/or linking and/or runtime.
...
Cody fixed this to work with modern compilers.
...
string of numbers on the same line.
...
Thanks go to Yusuke for providing a proper
...
Cody made this alternate version with
...
[herrmann2.alt.c](herrmann2.alt.c).


## [2001/kev](2001/kev/kev.c) ([README.md](2001/kev/README.md]))

Cody slowed down the ball
...
below, based on the author's remarks.
...
to get lost (or use the original version)!


## [2004/burley](2004/burley/burley.c) ([README.md](2004/burley/README.md]))

Cody fixed this to compile with
...
[/bugs.md](/bugs.md) for information here.
...
earlier in the code and to use that variable which `main()` used.


## [2005/aidan](2005/aidan/aidan.c) ([README.md](2005/aidan/README.md]))

Cody fixed the test script,
described by the author in their remarks, to refer to the proper compiled
program (it's hardcoded) which was never done which broke the script.
...
in which case just enjoy it for what it was.
...
malloc(). This prevented it from working.


## [2006/borsanyi](2006/borsanyi/borsanyi.c) ([README.md](2006/borsanyi/README.md]))

Cody fixed (the Makefile)
under some systems where the `lpthread` was not implicitly linked in.
...
As Cody is a lost :-) `vim`
user he took the author's remarks to add support back for arrow keys.


## [2006/sloane](2006/sloane/sloane.c) ([README.md](2006/sloane/README.md]))

Cody fixed this entry to
...
systems he added `-include ...` to the Makefile as well.

The [alternate version](2006/sloane/sloane.alt.c) was provided by Cody.
...
be that using `-m32` would let this work in 32-bit systems.


## [2011/eastman](2011/eastman/eastman.c) ([README.md](2011/eastman/README.md]))

Cody tested this with
...
here but he went ahead and did it anyway as it seems useful.
...
The author, Yusuke, supplied the additional
source files, which Cody
...
Cody fixed an unfortunate
typo in the Makefile that was preventing some of the files from compiling
properly, trying instead to compile already compiled code.
...
it sometimes segfaults but Cody did not try debugging it.
