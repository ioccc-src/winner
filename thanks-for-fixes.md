...
this entry either in full or in part. Also, some of the code generated by it
cannot be compiled by gcc either. Thus these changes are in the alt code.
Nevertheless the main features of the program does work in the alt version, it
just cannot generate every C file correctly.
