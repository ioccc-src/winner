#!/usr/bin/env bash
#
# try.sh - demonstrate IOCCC winner 2013/endoh1
#
...
read -r -n 1 -p "Press any key to run: ./endoh1 hello.lazy: "
echo 1>&2
./endoh1 hello.lazy
echo 1>&2
...
read -r -n 1 -p "Press any key to run: ./tac < endoh1.c | less (space = next page, q = quit): "
echo 1>&2
./tac < endoh1.c | less -EXF
echo 1>&2
