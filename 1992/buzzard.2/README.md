...
[FORTH](https://en.wikipedia.org/wiki/Forth_&lpar;programming_language&rpar;) manuals for
...
[FORTH](https://en.wikipedia.org/wiki/Forth_&lpar;programming_language&rpar;), which
...
[FORTH](https://en.wikipedia.org/wiki/Forth_&lpar;programming_language&rpar;) aficionados,
...
[FORTH](https://en.wikipedia.org/wiki/Forth_&lpar;programming_language&rpar;) to allow it
...
are primitives in
[FORTH](https://en.wikipedia.org/wiki/Forth_&lpar;programming_language&rpar;) (like swap)
take a significant amount of time in THIRD.

When you get the `Ok.` message from `third`, try out some sample
[FORTH](https://en.wikipedia.org/wiki/Forth_&lpar;programming_language&rpar;) code
...
[FORTH](https://en.wikipedia.org/wiki/Forth_&lpar;programming_language&rpar;) system in
