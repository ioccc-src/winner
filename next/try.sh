#!/usr/bin/env bash
#
# try.sh - demonstration of YYYY/XXX    <<=== The IOCCC Judges will replace this line

# XXX - remove text below, including this line				    - XXX
# XXX -									    - XXX
# XXX - NOTE: please remove all "XXX - ... - XXX" lines			    - XXX
# XXX -									    - XXX
# XXX - try.sh example version: 30.0.0 2026-04-21                           - XXX
# XXX -									    - XXX
...
# XXX -                                                                     - XXX
# XXX - For more examples, see the try.sh scripts under most recent	    - XXX
