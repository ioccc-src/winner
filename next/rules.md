...
# 30th International Obfuscated C Code Contest Official Rules

Copyright (c) 2026 Leonid A. Broukhis and Landon Curt Noll.
...
<p class="leftbar">
This IOCCC runs from `2026-12-08 02:00:02.102832 UTC` to `2027-04-02 06:00:04.240010 UTC`.
</p>

<p class="leftbar">
This contest will enter the [pending state](../faq.html#pending) on
`2026-11-07 21:20:15.193421 UTC`, allowing people to [register for the
IOCCC](../next/register.html).
</p>

<p class="leftbar">
This contest will enter the [open state](../faq.html#open) on
`2026-12-08 02:00:02.102832 UTC`, allowing people to [upload
submissions](../next/submit.html).
</p>

<p class="leftbar">
This contest will enter the [judging state](../faq.html#judging) on
`2027-04-02 06:00:04.240010 UTC`, when people will no longer be allowed
...
`mkiocccenty(1)` when packing a submission.
...
* The `Makefile`, `remarks.md`,`.info.json`, and `.auth.json`
...
<p class="leftbar">
You are permitted to use tools (including LLM tools) to write your code.
</p>
...
<p class="leftbar">
Each account has ten (**10.0000**) submission slots (**0..9)**.
</p>
...
<p class="leftbar">
See [Guidelines for Rule 16 - Anonymous
judging](guidelines.html#guideline16-anonymous-judging).
</p>
...
Additional rules, both humorous and humor impaired, may be added below this
