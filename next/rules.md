...
<p class="leftbar">
These [IOCCC rules](rules.html) are version **28.19 2025-01-30**.
</p>
...
<p class="leftbar">
Additionally, the submission tarball created by `mkiocccentry(1)` **MUST** have
the following files (generated by the `mkiocccentry(1)` tool):
</p>
